    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog babyData={offspring[0]} eyeColor={this.state.eyeColor}/>
          <BabyHog babyData={offspring[1]} eyeColor={this.state.eyeColor}/>
          <BabyHog babyData={offspring[2]} eyeColor={this.state.eyeColor}/>
        </ul>
